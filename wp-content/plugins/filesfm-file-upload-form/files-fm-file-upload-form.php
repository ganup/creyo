...
define('FILES_FM_UPLOAD__VERSION', '1.2');
...
function files_fm_upload__shortcode_handler( $atts ) {
    ...
    $str_embed_code = '';
    if ( ! empty( $str_username ) && ! empty( $str_addhash ) )
    {
    	$str_embed_code = '<script type="text/javascript" id="files_fm_upload_script_tag" src="' . FILES_FM_UPLOAD__EMBED_SCRIPT_HOST . FILES_FM_UPLOAD__EMBED_SCRIPT_PATH . '?addto='.$str_username.'&addhash='.$str_addhash.'&insert_before_id=files_fm_upload_script_tag&type=inline-form'. $config .''. $lang .'"></script>';
	}
