					...
					<form method="post" id="weblizar_rcsm_template_option">
						...
						<div style="width:48%" class="col-md-6 col-sm-6 op_tem site_template <?php if($wl_rcsm_options['select_template']=='select_template'.$i) echo 'active'; ?>" id="select_template<?php echo $i?>">	
							<div class="selected_template active">	
								...
								<span class="op_name1 green"><span class="activate"> <?php _e('Activated','RCSM_TEXT_DOMAIN'); ?></span>
								</span>
							</div>
						</div>
						<?php } ?>
						...
						<div style="width:48%" class="col-md-6 col-sm-6 op_tem site_template <?php if($wl_rcsm_options['select_template']=='select_template'.$i) echo 'active'; ?>" id="select_template<?php echo $i?>">	
							<div class="selected_template active">	
								...
								<h4 class="op_name"><?php _e('Template '.$i,'RCSM_TEXT_DOMAIN');?></h4>
								<span class="op_name1 blue"><span class="activate"><?php _e('<h3>Avalable In Pro Version!!! </h3> </br><a class="btn btn-success pro-link" target="_new" href="https://weblizar.com/plugins/coming-soon-page-maintenance-mode-pro/" rel="nofollow">Get Pro Plugin</a> ','RCSM_TEXT_DOMAIN');?> </span>
								</span>
							</div>
						</div>
						<?php } ?>													
						...
						<div class="row weblizar-theme-feature-detail">
							<div class="col-md-4 no-pad">
								<ul class="weblizar-pricing compaire">
									...
									</li><li>Multiple Pro Template</li>
