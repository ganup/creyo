        ...
        <div class="grid_24">
            ...
            <div class="grid_8 omega">
                <div class="copyrightinfo">
                    ...
                    <?php } else { ?>
                        <p class="copyright"><a href="<?php echo esc_url('http://www.inkthemes.com'); ?>">Poloray Theme</a> Powered By <a href="<?php echo esc_url('http://www.wordpress.org'); ?>">WordPress</a></p>
                    <?php } ?>
                </div>
            </div>
        </div>
