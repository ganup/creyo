...
function poloray_breadcrumbs() {
    $delimiter = '&raquo;';
    $home = __('Home', 'poloray'); // text for the 'Home' link
    ...
    if (is_category()) {
        ...
        echo $before . __('Archive by category', 'poloray') . ' "' . single_cat_title('', false) . '"' . $after;
    }
    elseif (is_day()) {
        ...
        echo $before . __('Search results for', 'poloray') . ' "' . get_search_query() . '"' . $after;
    } elseif (is_tag()) {
        echo $before . __('Posts tagged ', 'poloray') . '"' . single_tag_title('', false) . '"' . $after;
    } elseif (is_author()) {
        global $author;
        $userdata = get_userdata($author);
        echo $before . __('Articles posted by ', 'poloray') . $userdata->display_name . $after;
    } elseif (is_404()) {
        echo $before . __('Error 404', 'poloray') . $after;
    }
