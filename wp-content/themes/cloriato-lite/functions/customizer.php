...
class cloriato_Customizer {
    ...
    public static function cloriato_Settings() {
        $cloriato_settings = array(
            ...
            'inkthemes_upon' => array(
                'id' => 'inkthemes_options[inkthemes_upon]',
                'label' => __('Stumbleupon URL', 'cloriato-lite'),
                'description' => __('Enter your stumbleupon URL if you have one.', 'cloriato-lite'),
                'type' => 'option',
                'setting_type' => 'link',
                'default' => '#'
            ),
...
function inkthemes_registers() {
	...
	wp_localize_script( 'inkthemes_customizer_script', 'ink_advert', array(
		...
		'url' => esc_url('http://www.inkthemes.com/wp-themes/wordpress-charity-theme/'),
